...
// wrapc file define:
#define AUTOTB_TVIN_dataPoints "../tv/cdatafile/c.ellipse_solver.autotvin_dataPoints.dat"
#define AUTOTB_TVOUT_dataPoints "../tv/cdatafile/c.ellipse_solver.autotvout_dataPoints.dat"
#define AUTOTB_TVIN_matrix "../tv/cdatafile/c.ellipse_solver.autotvin_matrix.dat"
#define AUTOTB_TVOUT_matrix "../tv/cdatafile/c.ellipse_solver.autotvout_matrix.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_matrix "../tv/rtldatafile/rtl.ellipse_solver.autotvout_matrix.dat"
...
extern "C"
void ellipse_solver_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_ellipse_solver_hw(void* __xlx_apatb_param_dataPoints, void* __xlx_apatb_param_matrix)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_dataPoints),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_dataPoints),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_dataPoints };
  port0.depth = { 8 };
  port0.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_matrix),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_matrix),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_matrix),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_matrix),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_matrix),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_matrix),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_matrix };
  port1.depth = { 30 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  try {
    ...
    ellipse_solver_hw_stub_wrapper(__xlx_apatb_param_dataPoints, __xlx_apatb_param_matrix);
